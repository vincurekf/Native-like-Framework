...
.factory('$nativeDrawer', [function(){
  ...
  var nDrawer = {
    ...
    show: function(){
      ...
      nDrawer.open = true;
      nDrawer.reverse = true;
      nDrawer.burger.toggle(true);
    },
    hide: function(){
      // hide drawer
      drawer.style.transition = 'all '+nDrawer.options.speed+'s '+nDrawer.options.animation;
    ...
    move: function( ev, hold ){
      ...
      if( hold ){
        nDrawer.holdPos = nDrawer.holdPos ? nDrawer.holdPos : pos;
        pos = pos + Math.abs(nDrawer.holdPos);
      };
      pos = pos < 0 ? pos : 0;
    ...
    init: function( config ){
      ...
      var options = nDrawer.merge(nDrawer.options, config);
